<template>
  ...
  <div v-if="show" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
    <div class="bg-gray-800 rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
      <!-- Modal Header -->
      <div class="flex justify-between items-center p-4 border-b border-gray-700">
        <h2 class="text-xl font-semibold text-white">Take Photo</h2>
      ...
      <div class="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
        ...
        <div v-else class="space-y-6">
          <div class="text-center">
            <h3 class="text-lg font-semibold mb-4 text-white">Photo Captured!</h3>
            <img
              :src="capturedImage"
              alt="Captured photo"
